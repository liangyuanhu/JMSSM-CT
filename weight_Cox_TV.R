weight_Cox_TV <- function(exposure, numerator = NULL, denominator,
                  id, tstart, timevar, data, trunc= NULL, smooth){
    
#######################################################################################
#   Filename    :	weight_Cox_TV.R
#
#   Description :   modifed ipwtm function
#                   if smooth is set to TRUE, will perform kernel smoothing to smooth to N-A estimator
#                   
#    
#   Required package  :    survival
#
#   Usage       :   weight_Cox_TV(exposure, numerator, denominator,
